          ...
          <div className="divide-y divide-gray-200">
            ...
            <div className="flex gap-x-7 py-6">
              ...
              <div className="grow">
                ...
                <a href="https://wa.me/5491125653766" target="_blank" rel="noopener noreferrer" className="ml-3 mt-2 inline-flex items-center gap-x-2 text-sm font-medium text-lime-600 hover:text-lime-500 focus:outline-none focus:text-gray-800">
                  +54 9 11 2565-3766
                  <svg
                ...
                <a href="https://wa.me/34624354476" target="_blank" rel="noopener noreferrer" className="ml-3 mt-2 inline-flex items-center gap-x-2 text-sm font-medium text-lime-600 hover:text-lime-500 focus:outline-none focus:text-gray-800">
                  +34 624 35 44 76
                  <svg
                    className="shrink-0 size-2.5 transition ease-in-out group-hover:translate-x-1 group-focus:translate-x-1"
                    width="16"
