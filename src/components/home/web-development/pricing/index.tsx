  ...
  return (
    <div className="mt-16 lg:mt-0">
      <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        ...
        >
          <h2 className="text-3xl leading-tight font-bold md:text-4xl md:leading-tight lg:text-5xl lg:leading-tight bg-clip-text bg-gradient-to-r from-lime-500 to-lime-700 text-transparent">
            {t.title}
          </h2>
          ...
          <div className="space-y-24 lg:hidden">
            <table className="w-full h-px">
              ...
              <tbody className="border-t border-gray-200 divide-y divide-gray-200 ">
                ...
                <tr>
                  <th
                    className="py-3 ps-2 pe-2 text-sm font-normal text-gray-600 text-start"
                  >
                ...
                <tr>
                  <th
                    className="py-5 ps-2 pe-2 text-sm font-normal text-gray-600 text-start"
                  >
                ...
                <tr>
                  <th
                    className="py-3 ps-2 pe-2 text-sm font-normal text-gray-600 text-start whitespace-wrap"
                  >
                ...
                <tr>
                  <th
                    className="py-5 ps-2 pe-2 text-sm font-normal text-gray-600 text-start whitespace-wrap"
                  >
                ...
                <tr>
                  <th
                    className="py-5 ps-2 pe-2 text-sm font-normal text-transparent select-none text-start whitespace-wrap"
                  >
                    Buttons
                  </th>
