...
function Index() {
  ...
  // Precios fijos según país y tipo de página
  const fixedPrices = {
    "One Page": {
      priceArgentina: 232000,
      priceUSA: 250,
    },
    "Landing Page": {
      priceArgentina: 423000,
      priceUSA: 460,
    },
    "E-commerce": {
      priceArgentina: 696000,
      priceUSA: 1850,
    },
  } as const;

  type ModelName = keyof typeof fixedPrices;

  // Nueva función para obtener el precio fijo
  const getPriceByName = (name: ModelName, field: "priceUSA" | "priceArgentina") =>
    fixedPrices[name][field] || 0;

  const formatPrice = (price: number) =>
    new Intl.NumberFormat("es-AR").format(price);

  // Estado para priceKey y isArgentina, calculados solo en cliente
  const [priceKey, setPriceKey] = useState<"priceArgentina" | "priceUSA">("priceUSA");
  const [isArgentina, setIsArgentina] = useState(false);

  useEffect(() => {
    if (typeof window !== "undefined") {
      const url = window.location.href;
      if (url.endsWith("/ar/web-development")) {
        setPriceKey("priceArgentina");
        setIsArgentina(true);
      } else {
        setPriceKey("priceUSA");
  ...
  return (
    ...
    >
        ...
        <div className="relative z-10">
          <div className="mt-12 grid sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:items-start">
            ...
            <BlurFade inView delay={0.75}>
              <ShineBorder
                className="relative w-full flex flex-col border text-center shadow-xl rounded-lg items-center justify-center overflow-hidden bg-background md:shadow-xl"
      ...
      <BlurFade inView className="mt-20 lg:mt-32">
        <div
          id="web-development-comparation-models"
          className="lg:text-center mb-10 lg:mb-20"
        >
        ...
        <div className="space-y-24 lg:hidden">
          <table className="w-full h-px">
            ...
            <tbody className="border-t border-gray-200 divide-y divide-gray-200 ">
              ...
              <tr>
                <th
                  className="py-3 ps-6 bg-gray-50 font-bold text-gray-800 text-start text-sm w-full"
                  colSpan={4}
                  scope="colgroup"
                >
