...
export default function Web() {
  ...
  return (
    <div id="home-web-development" className="py-24 sm:py-32">
      ...
      <div id="home-ecommerce" className="flex flex-col items-center justify-center mx-auto space-y-12 lg:space-y-24">
        <div className="mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-8">
