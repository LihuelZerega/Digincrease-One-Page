...
function Index() {
  ...
  return (
    <div className="max-w-[85rem] px-4 sm:px-6 lg:px-8 py-12 sm:py-24 mx-auto">
                ...
                <span className="flex gap-x-6">
                  ...
                  <span className="grow">
                    ...
                    <span className="block mt-1 text-neutral-600">
                      {t.desarrolloWebText}
                      <a
                        className="ml-2 group inline-flex items-center gap-x-2 font-medium text-sm text-lime-600 hover:text-lime-500 decoration-2 hover:underline focus:outline-none focus:underline"
