      ...
      <div className="grid md:grid-cols-5 gap-10">
        ...
        <div className="md:col-span-3">
          <div className="w-full hs-accordion-group divide-y divide-gray-200">
            {[
              {
                question: "¿Qué diferencia hay entre un workflow y un bot de IA?",
                answer: "El workflow ejecuta reglas predefinidas, mientras que la IA entiende lenguaje natural y se adapta. Juntos son más potentes.",
              },
              {
                question: "¿Necesito saber programar para usar estas soluciones?",
                answer: "No. Nos ocupamos de toda la implementación y entregamos un sistema listo para usar.",
              },
              {
                question: "¿Puedo integrar la automatización con mis herramientas actuales?",
                answer: "Sí. Trabajamos con Google Sheets, CRMs, ERPs, WhatsApp API, Meta Ads y más.",
              },
              {
                question: "¿Qué soporte ofrecen?",
                answer: "Incluimos soporte post-entrega en todos los planes y ofrecemos mantenimiento mensual opcional.",
              },
            ].map((item, index) => (
              <div
                key={index}
